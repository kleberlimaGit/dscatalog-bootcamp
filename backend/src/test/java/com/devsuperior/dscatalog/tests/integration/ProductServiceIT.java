...
public class ProductServiceIT {
	...
	private long countTotalPcGamer;
	...
	@Test
	public void findAllPagedShouldReturnAllProductsWhenExistsIgnoringCase() {
		String name = "Pc gamer";
		Page<ProductDTO> result = service.findAllPaged(0L,name,pageRequest);
		
		Assertions.assertFalse(result.isEmpty());
		Assertions.assertEquals(countTotalPcGamer, result.getTotalElements());
	}
